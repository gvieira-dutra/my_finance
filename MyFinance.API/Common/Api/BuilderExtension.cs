    ...
    new Transaction
    {
        ...
        await context.AddRangeAsync(
            ...
            new Core.Models.Product
            {
                ...
                Description = "Enjoy all features, including premium content and support, with a recurring monthly subscription.",
                Price = 14.99M,
                IsActive = true
            },
            ...
            new Core.Models.Product
            {
                ...
                Description = "A great way to save while enjoying full platform benefits for six months.",
            ...
            new Core.Models.Product
            {
                ...
                Description = "Best value for long-term users. Get access to all premium features and content at a discounted annual rate.",
                Price = 129.99M,
                IsActive = true
            }
);
